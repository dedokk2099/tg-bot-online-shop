...
if not telegram_token:
    print("Ошибка: Не найден токен TELEGRAM_TOKEN в .env файле или переменных окружения!")
    exit()

if not payment_token:
    print("Ошибка: Не найден токен PAYMENT_PROVIDER_TOKEN в .env файле или переменных окружения!")
    exit()

...
class AdminInterface:
    ...
    def handle_photo_upload(self, message):
        ...
        try:
            ...
            # попытка добавить товар в базу данных
            database.addItem(new_product_id, user_state['name'], user_state['price'], user_state['description'], user_state['quantity'], photo_path)
    ...
    def handle_callback(self, call):
        ...
        if data[0] == "edit":
            ...
            try:
                ...
                # попытка удаления товара из базы данных
